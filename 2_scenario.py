# second scenario 3D PEdestrian detection bound boxing the straight walk 
#super similar to the frist scenario, i assume there is also shaddow of the pedestrian 
#visible form the data. could not detect the duck walked one. 
